...
<template>
  <section class="method section--lg bg-ink" aria-labelledby="method-heading">
    <div class="container">
      ...
      <ol class="method__rail" role="list">
        <li
          v-for="step in steps"
          :key="step.n"
          class="method__step"
...
/* Rail — 4-col grid on desktop, 2-col tablet, 1-col mobile */
.method__rail {
  display: grid;
