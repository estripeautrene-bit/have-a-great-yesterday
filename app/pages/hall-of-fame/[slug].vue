      ...
      <div class="container">
        <div class="hofe__foot-inner">
          ...
          <p class="hofe__disclaimer">
            {{ entry.name }} is cited here solely for their published intellectual contributions. HaveAGreatYesterday.com and the MyHGY™ Method are not affiliated with, sponsored by, or endorsed by {{ entry.name }}. This recognition does not imply any relationship, collaboration, or endorsement.
          </p>
